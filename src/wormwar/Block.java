 ...
 */
public class Block extends ScreenObject implements Runnable, Serializable {
    ...
    public Block(int x, int y, int w, int h, Color cl, ScreenManager sm) {
        super(x, y, w, h, cl);
        this.sm = sm;
    }
    ...
    public String setClassValue() {
        StringBuilder name = new StringBuilder("block ");
        name.setLength(6);
